...
//               MAKE GROUPHEAD INVISIBLE
               ...
               begin
                  case CBSummary.ItemIndex of
                    ...
                    3 : begin
                      ...
                      query_sum := init_query_reg_sum + filter_periode_reg + filter_periode_fact + filter_consign_reg + filter_consign_fact + filter_periode_fact + filter_cat_fact+ filter_type_fact + filter_TypeNave + filter_navire + filter_statut +group_filter + order_sum;
         ...
         begin
            ...
            query_print:= init_query_reg + filter_periode_reg + filter_periode_fact + filter_consign_reg + filter_consign_fact + filter_periode_fact + filter_cat_fact+ filter_type_fact + filter_TypeNave + filter_navire + filter_statut + order_group ;
//            DM.QPrint.Close;
//            DM.QPrint.SQL.Clear;
