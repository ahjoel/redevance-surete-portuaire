...
//               MAKE GROUPHEAD INVISIBLE
              ...
              begin
                   ...
                   TfrxGroupHeader(FEtatsFacturePal.frxReport.FindObject('GroupFooter')).Visible :=True;
               ...
               begin
                  case CBSummary.ItemIndex of
                    ...
                    4 : begin
                      ...
                      TfrxMemoView(FEtatsFacturePal.frxReport.FindObject('sum_montant_fact_data')).Text := '[frxDBDataset_sum."mt_fact"]' ;
                      TfrxMemoView(FEtatsFacturePal.frxReport.FindObject('sum_montant_regle_data')).Text := '[frxDBDataset_sum."mt_regle"]' ;
                      TfrxMemoView(FEtatsFacturePal.frxReport.FindObject('sum_montant_solde_data')).Text := '[frxDBDataset_sum."mt_solde"]' ;
