...
type
  TFEditFactRadePal = class(TUniForm)
    ...
    procedure EdNavireChange(Sender: TObject);
  private
                            ...
                            case Res of
                              mrYes :
                                  begin
                                        with DM.QSave do
                                              begin
                                                  SQL.Text := ('INSERT INTO facture_pal (rade_facture_pal, ref_facture_pal, consignataire_facture_pal, montant_facture_pal, date_emise_facture_pal, date_trans_facture_pal, date_ech_facture_pal, type_facture, user_create_facture_pal , exercice_facture_pal )'#13+
                                                          ' Values (:rade, :ref, :consignataire, :montant, :emis, :trans, :echeance, :type_facture, :user_create, :exercice)');
...
procedure TFEditFactRadePal.EdNavireChange(Sender: TObject);
begin
