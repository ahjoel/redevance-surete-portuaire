...
procedure TFEditNavire.ClearData;
  begin
      EdNom.Clear;
      EdImma.Clear;
      DBLTypeNav.KeyValue := null;
                                                ...
                                                ClearData;
                                                 ...
                                                 with DM.QMax  do
                                                   begin
                                                       close;
                                                       SQL.Clear;
                                                        SQL.Add('select max(id_navire) from navire');
                                                        ExecSQL;
                                                       Open;
                                                   end;
                                                   ...
                                                   FNavire.ShowData;
                                                   DM.DQ_Grid_Navire.Locate('id_navire',dm.QMax.Fields[0].AsString,[loCaseInsensitive] );
                                              end;
